...
export default {
    ...
    computed: {
        baidu_address () {
            return this.$STATIC_URL + '/images/expressions/baidu.png'
        }
    }
}
</script>
...
<template>
    <div class="expression">
        <div class="default-expression">
            <div v-for="(item,index) in 49" :key="index">
                <div :style="`background-position: left -${index * 30}px;background-image: url(${baidu_address});`"></div>
            </div>
        </div>
